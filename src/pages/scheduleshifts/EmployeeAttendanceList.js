...
const EmployeeAttendanceList = () => {
  ...
  useEffect(() => {
    ...
    empId && dispatch(fetchEmployeeAttendaceById(data));
    empId && setEmployeeId(empId);
  }, [empId]);
  ...
  useEffect(() => {
    ...
    employeeAttendanceList && setTotalHours(employeeAttendanceList?.totalHours);
  }, [employeeAttendanceList]);
          ...
          <div className="employee-aatendance-top">
            <div className="col-left">
              <div className="form-group attendance-range-picker">
                <CDateRangePicker handleDates={setRangeDates} />
              </div>
            </div>
